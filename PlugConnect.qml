...
Rectangle {
    ...
    Component.onCompleted: {
        ...
        {
            txtHomepage.text = "Plug the charging cable into your EV."
        }
        else if(isLanguageEnglish === false)
        {
            txtHomepage.text = "Şarj kablosunu aracınıza takınız."
        }
    ...
    Image {
        ...
        Text {
            ...
            width: 620
            height: 40
            text: qsTr("Şarj kablosunu aracınıza takınız.")
            font.pixelSize: 22
